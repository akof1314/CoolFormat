...
TidyDeafult GlobalTidy::m_TidyNames[MAX_SYN_LANG] = {
	...
	{_T("C++"),					_T("-A1-p-N-Y-k3-xC200"),																			SYN_CPP},
	{_T("C#"),					_T("-A1-p-N-Y-k3-xC200"),																			SYN_CS},
	...
	{_T("Java"),				_T("-A1-p-N-Y-k3-xC200"),																			SYN_JAVA},
	...
	{_T("Objective-C"),			_T("-A1-p-N-Y-k3-xC200"),																			SYN_OBJECTIVEC},
